...
class UpdateBuilder<T>
    with FilterMixin<UpdateBuilder<T>>
    implements Future<QueryResult<T>> {
  UpdateBuilder(this._client, this.state, this._map);
  ...
  @override
  UpdateBuilder<T> withState(QueryState state) =>
      UpdateBuilder<T>(_client, state, _map);

  /// Choose which columns to return after the update.
  UpdateBuilder<T> select([String columns = '*']) =>
